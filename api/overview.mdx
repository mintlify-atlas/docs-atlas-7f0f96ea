---
title: "Ferromax ERP REST API Reference"
sidebarTitle: "Overview"
description: "The Ferromax ERP REST API exposes endpoints for products, sales, inventory, dashboard, catalog, and real-time WebSocket events. Base URL: http://localhost:8081/api."
---
