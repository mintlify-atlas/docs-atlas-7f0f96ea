...
<ResponseField name="[].medioPago" type="string">
  Payment method. One of: `EFECTIVO`, `TRANSFERENCIA`, `TARJETA_DEBITO`, `TARJETA_CREDITO`, `CUENTA_CORRIENTE`.
</ResponseField>
...
<ResponseField name="[].origen" type="string">
  Sale origin channel. One of: `POS`, `PEDIDO`. Defaults to `"POS"` when origin is not recorded.
</ResponseField>
