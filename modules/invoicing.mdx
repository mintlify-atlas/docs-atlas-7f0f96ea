---
title: "Supplier Invoice OCR: Automated Stock Ingestion from PDFs"
sidebarTitle: "Invoice Scanning"
description: "Upload supplier invoices as PDF or image. Ferromax ERP uses OCR to extract line items, match products by SKU, and update stock on confirmation."
---
...
The free tier of OCR.space supports **25,000 API requests per month**. For production environments with high invoice volumes, consider upgrading to a paid OCR.space tier.
